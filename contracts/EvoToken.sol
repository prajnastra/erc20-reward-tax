...
contract EvoToken is ERC20, Ownable {
  ...
  uint256 public buyFeeTreasury = 1;
  uint256 public buyFeeReserve = 1;

  uint256 public sellFeeTreasury = 1;
  uint256 public sellFeeReserve = 1;
  ...
  constructor(address _router) ERC20('Test', 'TCO', uint8(DECIMALS)) {
